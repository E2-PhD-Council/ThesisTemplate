...
\input{TemplateFiles/ErrorHandling.tex}
...
\noindent\begin{minipage}[t][5cm][t]{\textwidth}
    \begin{center}
...
\noindent\begin{minipage}[t][4cm][b]{\textwidth}
    \begin{center}
    \vfill
    \vspace{5.5 cm}
...
\noindent\textbf{\ThePrintingLocationPageTitle}\\
\ifdefined \ThePrintingLocationPageSubitle \if \ThePrintingLocationPageSubitle\empty\else
    \noindent{\footnotesize\textit{\ThePrintingLocationPageSubitle}}\\
\fi\fi\\
{\textsc{\ThePrintingLocationPageAuthor}}\\
ISBN \TheISBN\\
~\\~\\
\copyright~\TheYear~\textsc{\ThePrintingLocationPageAuthor}\\ All rights reserved.\\
~\\~\\
...
\ifdefined \TheCoverImageCaption\ifdefined\TheCoverImage\if\TheCoverImage\empty\else\if\TheCoverImageCaption\empty\else
    \noindent Cover:\\\TheCoverImageCaption\\~\\
\fi\fi\fi\fi
\noindent Printed by \ThePrinter \\Gothenburg, Sweden, \TheMonth~\TheYear
...
\pagenumbering{roman}
\setcounter{page}{1}
\setlength{\parindent}{1em} % Reset parindent to original value

% Print the header
\noindent\textbf{\TheAbstractPageTitle}\\
\ifdefined \TheAbstractPageSubitle \if \TheAbstractPageSubitle\empty\else
    \noindent{\footnotesize\textit{\TheAbstractPageSubitle}}\\
\fi\fi
